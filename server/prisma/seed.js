...
async function main() {
  ...
  const transactions = [
    ...
    { type: 'expense', amount: 55000,   memo: '핸드폰 요금',        date: '2025-01-10', categoryId: cat('기타'),        accountId: 'acc-bank',   isRecurring: true },
    { type: 'expense', amount: 17900,   memo: '넷플릭스',           date: '2025-01-12', categoryId: cat('기타'),        accountId: 'acc-credit', isRecurring: true },
    { type: 'expense', amount: 9900,    memo: '유튜브 프리미엄',    date: '2025-01-12', categoryId: cat('기타'),        accountId: 'acc-credit', isRecurring: true },
    ...
    { type: 'expense', amount: 9500,    memo: '스타벅스',           date: '2025-01-07', categoryId: cat('식비'),        accountId: 'acc-credit' },
    { type: 'expense', amount: 14500,   memo: '저녁 — 삼겹살',      date: '2025-01-08', categoryId: cat('식비'),        accountId: 'acc-check' },
    { type: 'expense', amount: 6500,    memo: '편의점',             date: '2025-01-09', categoryId: cat('식비'),        accountId: 'acc-cash' },
    ...
    { type: 'expense', amount: 22000,   memo: '영화 — 오펜하이머',  date: '2025-01-18', categoryId: cat('기타'),        accountId: 'acc-credit' },
    ...
    { type: 'expense', amount: 5500,    memo: '카페 라떼',          date: '2025-01-30', categoryId: cat('식비'),        accountId: 'acc-check' },
    ...
    { type: 'expense', amount: 55000,   memo: '핸드폰 요금',        date: '2025-02-10', categoryId: cat('기타'),        accountId: 'acc-bank',   isRecurring: true },
    { type: 'expense', amount: 17900,   memo: '넷플릭스',           date: '2025-02-12', categoryId: cat('기타'),        accountId: 'acc-credit', isRecurring: true },
    { type: 'expense', amount: 9900,    memo: '유튜브 프리미엄',    date: '2025-02-12', categoryId: cat('기타'),        accountId: 'acc-credit', isRecurring: true },
    ...
    { type: 'expense', amount: 8500,    memo: '메가커피',           date: '2025-02-04', categoryId: cat('식비'),        accountId: 'acc-check' },
    { type: 'expense', amount: 29000,   memo: '설날 선물',          date: '2025-02-06', categoryId: cat('쇼핑'),        accountId: 'acc-credit' },
    { type: 'income',  amount: 100000,  memo: '설날 용돈',          date: '2025-02-07', categoryId: cat('기타수입'),    accountId: 'acc-cash' },
    ...
    { type: 'expense', amount: 33000,   memo: '공연 티켓',          date: '2025-02-22', categoryId: cat('기타'),        accountId: 'acc-credit' },
    { type: 'income',  amount: 5200,    memo: '이자 수익',          date: '2025-02-28', categoryId: cat('기타수입'),    accountId: 'acc-bank' },
    ...
    { type: 'expense', amount: 55000,   memo: '핸드폰 요금',        date: '2025-03-10', categoryId: cat('기타'),        accountId: 'acc-bank',   isRecurring: true },
    { type: 'expense', amount: 17900,   memo: '넷플릭스',           date: '2025-03-12', categoryId: cat('기타'),        accountId: 'acc-credit', isRecurring: true },
    { type: 'expense', amount: 9900,    memo: '유튜브 프리미엄',    date: '2025-03-12', categoryId: cat('기타'),        accountId: 'acc-credit', isRecurring: true },
    { type: 'expense', amount: 41000,   memo: '마트 장보기',        date: '2025-03-01', categoryId: cat('식비'),        accountId: 'acc-check' },
    { type: 'expense', amount: 8800,    memo: '카페인 충전',        date: '2025-03-03', categoryId: cat('식비'),        accountId: 'acc-check' },
    ...
    { type: 'expense', amount: 4500,    memo: '편의점 간식',        date: '2025-03-11', categoryId: cat('식비'),        accountId: 'acc-cash' },
    ...
    { type: 'expense', amount: 22000,   memo: '영화 — 위키드',      date: '2025-03-20', categoryId: cat('기타'),        accountId: 'acc-credit' },
    ...
    { type: 'expense', amount: 7800,    memo: '편의점',             date: '2025-03-28', categoryId: cat('식비'),        accountId: 'acc-cash' },
    { type: 'expense', amount: 11500,   memo: '약국 — 비타민',      date: '2025-03-29', categoryId: cat('의료/건강'),  accountId: 'acc-check' },
    { type: 'income',  amount: 5100,    memo: '이자 수익',          date: '2025-03-31', categoryId: cat('기타수입'),    accountId: 'acc-bank' },
    ...
    { type: 'expense', amount: 55000,   memo: '핸드폰 요금',        date: '2025-04-10', categoryId: cat('기타'),        accountId: 'acc-bank',   isRecurring: true },
    { type: 'expense', amount: 17900,   memo: '넷플릭스',           date: '2025-04-12', categoryId: cat('기타'),        accountId: 'acc-credit', isRecurring: true },
    { type: 'expense', amount: 9900,    memo: '유튜브 프리미엄',    date: '2025-04-12', categoryId: cat('기타'),        accountId: 'acc-credit', isRecurring: true },
    { type: 'expense', amount: 52000,   memo: '마트 장보기',        date: '2025-04-03', categoryId: cat('식비'),        accountId: 'acc-check' },
    { type: 'expense', amount: 10500,   memo: '아메리카노 2잔',     date: '2025-04-04', categoryId: cat('식비'),        accountId: 'acc-check' },
    { type: 'expense', amount: 13000,   memo: '점심 — 국밥',        date: '2025-04-07', categoryId: cat('식비'),        accountId: 'acc-cash' },
    { type: 'expense', amount: 320000,  memo: '항공권 (여름 여행)', date: '2025-04-08', categoryId: cat('기타'),        accountId: 'acc-credit' },
